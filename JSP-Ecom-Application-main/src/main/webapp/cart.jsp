                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${order.cartProducts}" var="o">
                                <tr>
                                    ...
                                    <td>
                                        <fmt:formatNumber var="formattedPrice" value="${o.price}" type="number" minFractionDigits="2" maxFractionDigits="2"/>
                                        <input name="product-price" class="form-control-plaintext h5 text-black"
                                               value="${formattedPrice}" style="text-align: center" readonly>
                                    </td>
                                    ...
                                    <td>
                                        <fmt:formatNumber var="formattedProductTotal" value="${o.price * o.quantity}" type="number" minFractionDigits="2" maxFractionDigits="2"/>
                                        <input name="product-price-total" class="form-control-plaintext h5 text-black"
                                               value="${formattedProductTotal}" style="text-align: center" readonly>
                                    </td>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6 text-right">
                                    <fmt:formatNumber var="formattedTotal" value="${total_price}" type="number" minFractionDigits="2" maxFractionDigits="2"/>
                                    <input name="order-price-total" class="form-control-plaintext h5 text-black"
                                           value="${formattedTotal}" style="text-align: center" readonly>
                                </div>
                            </div>
